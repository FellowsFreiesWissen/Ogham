...
csv = dir_path + "\\" + "cisp_stones_qs.csv"
...
for index, row in data.iterrows():
    ...
    # inscription
    line += "" + "LAST" + "\t" + "P1684" + "\t" + "ga:\"" + str(row['inscription']).replace("\r\n", "") + "\"" + "\t" + "P248" + "\t" + "Q106628017" + "\r\n"
    # inventory number
    line += "" + "LAST" + "\t" + "P195" + "\t" + "" + "Q106674066" + "" + "\r\n"
    line += "" + "LAST" + "\t" + "P217" + "\t" + "\"" + str(row['ino']).replace(".0", "") + "\"" + "\t" + "P195" + "\t" + "Q106628017" + "\r\n"
    # add line to output array
    lines.append(line)

# write output file
file_out = dir_path + "\\" + "wd_cisp_import.qs"
